	...
	if(deviceProperties.lightSettingsBrightnessManual !== undefined && (deviceProperties.lightSettingsManualLightingActiveMode !== undefined || deviceProperties.lightSettingsManualDailyLighting !== undefined || deviceProperties.lightSettingsManualDynamicLighting !== undefined || deviceProperties.lightSettingsBrightnessSchedule !== undefined || deviceProperties.lightSettingsScheduleLightingActiveMode !== undefined || deviceProperties.lightSettingsScheduleDailyLighting !== undefined || deviceProperties.lightSettingsScheduleDynamicLighting !== undefined || deviceProperties.lightSettingsMotionTriggered !== undefined || deviceProperties.lightSettingsMotionTriggeredTimer !== undefined || deviceProperties.lightSettingsMotionActivationMode !== undefined || deviceProperties.lightSettingsBrightnessMotion !== undefined || deviceProperties.lightSettingsMotionLightingActiveMode !== undefined || deviceProperties.lightSettingsMotionDailyLighting !== undefined || deviceProperties.lightSettingsMotionDynamicLighting !== undefined)) {
		deviceModal += `
								<div class="card mb-3" id="cardDeviceLightSettings">
									...
									<div class="card-body">`;
		if (devicePropertiesMetadata.lightSettingsBrightnessManual !== undefined || devicePropertiesMetadata.lightSettingsManualLightingActiveMode !== undefined || devicePropertiesMetadata.lightSettingsManualDailyLighting !== undefined || devicePropertiesMetadata.lightSettingsManualDynamicLighting !== undefined) {
			deviceModal += `
										<h5>${translateContent("lblManualLighting")}</h5>
										${devicePropertiesMetadata.lightSettingsBrightnessManual === undefined ? "" : generateElementRange("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsBrightnessManual.name, deviceProperties.lightSettingsBrightnessManual, setEventHandler, devicePropertiesMetadata.lightSettingsBrightnessManual.unit, devicePropertiesMetadata.lightSettingsBrightnessManual.min, devicePropertiesMetadata.lightSettingsBrightnessManual.max, devicePropertiesMetadata.lightSettingsBrightnessManual.default)}
										${devicePropertiesMetadata.lightSettingsManualLightingActiveMode === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsManualLightingActiveMode.name, deviceProperties.lightSettingsManualLightingActiveMode, setEventHandler, devicePropertiesMetadata.lightSettingsManualLightingActiveMode.states)}
										${devicePropertiesMetadata.lightSettingsManualDailyLighting === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsManualDailyLighting.name, deviceProperties.lightSettingsManualDailyLighting, setEventHandler, devicePropertiesMetadata.lightSettingsManualDailyLighting.states)}
										${devicePropertiesMetadata.lightSettingsManualDynamicLighting === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsManualDynamicLighting.name, deviceProperties.lightSettingsManualDynamicLighting, setEventHandler, devicePropertiesMetadata.lightSettingsManualDynamicLighting.states)}`;
		}
		if (devicePropertiesMetadata.lightSettingsBrightnessSchedule !== undefined || devicePropertiesMetadata.lightSettingsScheduleLightingActiveMode !== undefined || devicePropertiesMetadata.lightSettingsScheduleDailyLighting !== undefined || devicePropertiesMetadata.lightSettingsScheduleDynamicLighting !== undefined) {
			deviceModal += `
										${devicePropertiesMetadata.lightSettingsBrightnessManual !== undefined || devicePropertiesMetadata.lightSettingsManualLightingActiveMode !== undefined || devicePropertiesMetadata.lightSettingsManualDailyLighting !== undefined || devicePropertiesMetadata.lightSettingsManualDynamicLighting !== undefined ? "<hr />" : ""}
										<h5>${translateContent("lblScheduleLighting")}</h5>
										${devicePropertiesMetadata.lightSettingsBrightnessSchedule === undefined ? "" : generateElementRange("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsBrightnessSchedule.name, deviceProperties.lightSettingsBrightnessSchedule, setEventHandler, devicePropertiesMetadata.lightSettingsBrightnessSchedule.unit, devicePropertiesMetadata.lightSettingsBrightnessSchedule.min, devicePropertiesMetadata.lightSettingsBrightnessSchedule.max, devicePropertiesMetadata.lightSettingsBrightnessSchedule.default)}
										${devicePropertiesMetadata.lightSettingsScheduleLightingActiveMode === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsScheduleLightingActiveMode.name, deviceProperties.lightSettingsScheduleLightingActiveMode, setEventHandler, devicePropertiesMetadata.lightSettingsScheduleLightingActiveMode.states)}
										${devicePropertiesMetadata.lightSettingsScheduleDailyLighting === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsScheduleDailyLighting.name, deviceProperties.lightSettingsScheduleDailyLighting, setEventHandler, devicePropertiesMetadata.lightSettingsScheduleDailyLighting.states)}
										${devicePropertiesMetadata.lightSettingsScheduleDynamicLighting === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsScheduleDynamicLighting.name, deviceProperties.lightSettingsScheduleDynamicLighting, setEventHandler, devicePropertiesMetadata.lightSettingsScheduleDynamicLighting.states)}`;
		}
		if (devicePropertiesMetadata.lightSettingsMotionTriggered !== undefined || devicePropertiesMetadata.lightSettingsMotionTriggeredTimer !== undefined || devicePropertiesMetadata.lightSettingsMotionActivationMode !== undefined || devicePropertiesMetadata.lightSettingsBrightnessMotion !== undefined || devicePropertiesMetadata.lightSettingsMotionLightingActiveMode !== undefined || devicePropertiesMetadata.lightSettingsMotionDailyLighting !== undefined || devicePropertiesMetadata.lightSettingsMotionDynamicLighting !== undefined) {
			deviceModal += `
										${devicePropertiesMetadata.lightSettingsBrightnessManual !== undefined || devicePropertiesMetadata.lightSettingsManualLightingActiveMode !== undefined || devicePropertiesMetadata.lightSettingsManualDailyLighting !== undefined || devicePropertiesMetadata.lightSettingsManualDynamicLighting !== undefined || devicePropertiesMetadata.lightSettingsBrightnessSchedule !== undefined || devicePropertiesMetadata.lightSettingsScheduleLightingActiveMode !== undefined || devicePropertiesMetadata.lightSettingsScheduleDailyLighting !== undefined || devicePropertiesMetadata.lightSettingsScheduleDynamicLighting !== undefined ? "<hr />" : ""}
										<h5>${translateContent("lblMotionLighting")}</h5>
										${devicePropertiesMetadata.lightSettingsMotionTriggered === undefined ? "" : generateElementSwitch("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsMotionTriggered.name, deviceProperties.lightSettingsMotionTriggered, devicePropertiesMetadata.lightSettingsMotionTriggered.writeable, setEventHandler)}
										${devicePropertiesMetadata.lightSettingsMotionTriggeredTimer === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsMotionTriggeredTimer.name, deviceProperties.lightSettingsMotionTriggeredTimer, setEventHandler, devicePropertiesMetadata.lightSettingsMotionTriggeredTimer.states)}
										${devicePropertiesMetadata.lightSettingsMotionActivationMode === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsMotionActivationMode.name, deviceProperties.lightSettingsMotionActivationMode, setEventHandler, devicePropertiesMetadata.lightSettingsMotionActivationMode.states)}
										${devicePropertiesMetadata.lightSettingsBrightnessMotion === undefined ? "" : generateElementRange("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsBrightnessMotion.name, deviceProperties.lightSettingsBrightnessMotion, setEventHandler, devicePropertiesMetadata.lightSettingsBrightnessMotion.unit, devicePropertiesMetadata.lightSettingsBrightnessMotion.min, devicePropertiesMetadata.lightSettingsBrightnessMotion.max, devicePropertiesMetadata.lightSettingsBrightnessMotion.default)}
										${devicePropertiesMetadata.lightSettingsMotionLightingActiveMode === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsMotionLightingActiveMode.name, deviceProperties.lightSettingsMotionLightingActiveMode, setEventHandler, devicePropertiesMetadata.lightSettingsMotionLightingActiveMode.states)}
										${devicePropertiesMetadata.lightSettingsMotionDailyLighting === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsMotionDailyLighting.name, deviceProperties.lightSettingsMotionDailyLighting, setEventHandler, devicePropertiesMetadata.lightSettingsMotionDailyLighting.states)}
										${devicePropertiesMetadata.lightSettingsMotionDynamicLighting === undefined ? "" : generateElementSelect("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.lightSettingsMotionDynamicLighting.name, deviceProperties.lightSettingsMotionDynamicLighting, setEventHandler, devicePropertiesMetadata.lightSettingsMotionDynamicLighting.states)}`;
		}
		deviceModal += `
									</div>
								</div>`;
		...
		if((deviceProperties.notification !== undefined && deviceProperties.notification === true) || deviceProperties.notification === undefined) {
			...
			if(deviceProperties.notificationPerson || deviceProperties.notificationPet || deviceProperties.notificationCrying !== undefined || deviceProperties.notificationAllSound !== undefined || deviceProperties.notificationAllOtherMotion !== undefined || deviceProperties.notificationRing !== undefined || deviceProperties.notificationMotion !== undefined || deviceProperties.notificationRadarDetector !== undefined) {
				deviceModal += `
										...
										${deviceProperties.notificationVehicle !== undefined ? `${generateElementSwitch("Device", deviceProperties.serialNumber, deviceProperties.name, devicePropertiesMetadata.notificationVehicle.name, deviceProperties.notificationVehicle, devicePropertiesMetadata.notificationVehicle.writeable, setEventHandler)}` : ""}
	...
	if(stationPropertiesMetadata.sdCapacity !== undefined || stationPropertiesMetadata.sdCapacityAvailable !== undefined) {
		...
		if(stationPropertiesMetadata.sdCapacity !== undefined || stationPropertiesMetadata.sdCapacityAvailable !== undefined) {
			...
			if(stationProperties.sdCapacity !== undefined && stationProperties.sdCapacity >= 0 && stationProperties.sdCapacityAvailable !== undefined && stationProperties.sdCapacityAvailable >= 0) {
				var capacityUnits = ["", "", ""];
				var rawSdCapacityValue = stationProperties.sdCapacity/conversionFactor;
				if(rawSdCapacityValue >= 1024) {
					var sdCapacity = (rawSdCapacityValue/1024).toFixed(2);
					capacityUnits[0] = "TB";
				} else {
					var sdCapacity = (rawSdCapacityValue).toFixed(2);
					capacityUnits[0] = "GB";
				}
				var rawSdCapacityAvailableValue = stationProperties.sdCapacityAvailable/conversionFactor;
				if(rawSdCapacityAvailableValue >= 1024) {
					var sdCapacityAvailable = (rawSdCapacityAvailableValue/1024).toFixed(2);
					capacityUnits[2] = "TB";
				} else {
					var sdCapacityAvailable = (rawSdCapacityAvailableValue).toFixed(2);
					capacityUnits[2] = "GB";
				}
				var rawSdCapacityUsedValue = (rawSdCapacityValue) - (rawSdCapacityAvailableValue);
				if(rawSdCapacityUsedValue >= 1024) {
					var sdCapacityUsed = (rawSdCapacityUsedValue/1024).toFixed(2);
					capacityUnits[1] = "TB";
				} else if(rawSdCapacityUsedValue < 0.01) {
					var sdCapacityUsed = (rawSdCapacityUsedValue*conversionFactor).toFixed(2);
					capacityUnits[1] = "MB";
				} else {
					var sdCapacityUsed = (rawSdCapacityUsedValue).toFixed(2);
					capacityUnits[1] = "GB";
				}
				var sdCapacityUsedPercent = (rawSdCapacityUsedValue/rawSdCapacityValue*100).toFixed(0);
				stationModal += `
	...
	if(stationPropertiesMetadata.storageInfoEmmc !== undefined || stationPropertiesMetadata.storageInfoHdd !== undefined || stationPropertiesMetadata.storageInfoSdCard !== undefined) {
		...
		if(stationProperties.storageInfoEmmc !== undefined) {
			...
			if(stationProperties.storageInfoEmmc.disk_size !== undefined && stationProperties.storageInfoEmmc.disk_size > 0 && stationProperties.storageInfoEmmc.system_size !== undefined && stationProperties.storageInfoEmmc.system_size >= 0 && stationProperties.storageInfoEmmc.disk_used !== undefined && stationProperties.storageInfoEmmc.disk_used >= 0 && stationProperties.storageInfoEmmc.data_used_percent !== undefined && stationProperties.storageInfoEmmc.data_used_percent >= 0 && stationProperties.storageInfoEmmc.video_size !== undefined && stationProperties.storageInfoEmmc.video_size >= 0 && stationProperties.storageInfoEmmc.video_used !== undefined && stationProperties.storageInfoEmmc.video_used >= 0 && stationProperties.storageInfoEmmc.data_partition_size !== undefined && stationProperties.storageInfoEmmc.data_partition_size >= 0 && stationProperties.storageInfoEmmc.eol_percent !== undefined && stationProperties.storageInfoEmmc.eol_percent >= 0) {
				var capacityUnits = ["", "", "", ""];
				var rawStorageInfoEmmcDiskSizeValue = stationProperties.storageInfoEmmc.disk_size/conversionFactor;
				if(rawStorageInfoEmmcDiskSizeValue >= 1024) {
					var emmcCapacity = (rawStorageInfoEmmcDiskSizeValue/1024).toFixed(2);
					capacityUnits[0] = "TB";
				} else {
					var emmcCapacity = (rawStorageInfoEmmcDiskSizeValue).toFixed(2);
					capacityUnits[0] = "GB";
				}
				var rawStorageInfoEmmcDiskUsedValue = stationProperties.storageInfoEmmc.disk_used/conversionFactor;
				if(rawStorageInfoEmmcDiskUsedValue >= 1024) {
					var emmcCapacityUsed = (rawStorageInfoEmmcDiskUsedValue/1024).toFixed(2);
					capacityUnits[1] = "TB";
				} else {
					var emmcCapacityUsed = (rawStorageInfoEmmcDiskUsedValue).toFixed(2);
					capacityUnits[1] = "GB";
				}
				var rawStorageInfoEmmcDiskCapacityAvailableValue = rawStorageInfoEmmcDiskSizeValue-rawStorageInfoEmmcDiskUsedValue;
				if(rawStorageInfoEmmcDiskCapacityAvailableValue >= 1024) {
					var emmcCapacityAvailable = (rawStorageInfoEmmcDiskCapacityAvailableValue/1024).toFixed(2);
					capacityUnits[2] = "TB";
				} else if(rawStorageInfoEmmcDiskCapacityAvailableValue < 0.01) {
					var emmcCapacityAvailable = (rawStorageInfoEmmcDiskCapacityAvailableValue*conversionFactor).toFixed(2);
					capacityUnits[2] = "MB";
				} else {
					var emmcCapacityAvailable = (rawStorageInfoEmmcDiskCapacityAvailableValue).toFixed(2);
					capacityUnits[2] = "GB";
				}
				var emmcCapacityUsedPercent = (rawStorageInfoEmmcDiskUsedValue/rawStorageInfoEmmcDiskSizeValue*100).toFixed(0);
				var rawStorageInfoEmmcDiskVideoUsedValue = (stationProperties.storageInfoEmmc.video_used/conversionFactor)/conversionFactor;
				if(rawStorageInfoEmmcDiskVideoUsedValue >= 1024) {
					var emmcVideoUsed = (rawStorageInfoEmmcDiskVideoUsedValue/1024).toFixed(2);
					capacityUnits[3] = "TB";
				} else if(rawStorageInfoEmmcDiskVideoUsedValue < 0.01) {
					var emmcVideoUsed = (rawStorageInfoEmmcDiskVideoUsedValue*conversionFactor).toFixed(2);
					capacityUnits[3] = "MB";
				} else {
					var emmcVideoUsed = (rawStorageInfoEmmcDiskVideoUsedValue).toFixed(2);
					capacityUnits[3] = "GB";
				}
		...
		if(stationProperties.storageInfoHdd !== undefined) {
			...
			if(stationProperties.storageInfoHdd.disk_size !== undefined && stationProperties.storageInfoHdd.disk_size > 0 && stationProperties.storageInfoHdd.system_size !== undefined && stationProperties.storageInfoHdd.system_size >= 0 && stationProperties.storageInfoHdd.disk_used !== undefined &&  stationProperties.storageInfoHdd.disk_used >= 0 && stationProperties.storageInfoHdd.video_size !== undefined && stationProperties.storageInfoHdd.video_size >= 0 && stationProperties.storageInfoHdd.video_used !== undefined && stationProperties.storageInfoHdd.video_used >= 0) {
				var capacityUnits = ["", "", "", ""];
				var rawStorageInfoHddDiskSizeValue = stationProperties.storageInfoHdd.disk_size/conversionFactor;
				if(rawStorageInfoHddDiskSizeValue >= 1024) {
					var hddCapacity = (rawStorageInfoHddDiskSizeValue/1024).toFixed(2);
					capacityUnits[0] = "TB";
				} else {
					var hddCapacity = (rawStorageInfoHddDiskSizeValue).toFixed(2);
					capacityUnits[0] = "GB";
				}
				var rawStorageInfoHddDiskUsedValue = stationProperties.storageInfoHdd.disk_used/conversionFactor;
				if(rawStorageInfoHddDiskUsedValue >= 1024) {
					var hddCapacityUsed = (rawStorageInfoHddDiskUsedValue/1024).toFixed(2);
					capacityUnits[1] = "TB";
				} else {
					var hddCapacityUsed = (rawStorageInfoHddDiskUsedValue).toFixed(2);
					capacityUnits[1] = "GB";
				}
				var rawStorageInfoHddDiskCapacityAvailableValue = rawStorageInfoHddDiskSizeValue-rawStorageInfoHddDiskUsedValue;
				if(rawStorageInfoHddDiskCapacityAvailableValue >= 1024) {
					var hddCapacityAvailable = (rawStorageInfoHddDiskCapacityAvailableValue/1024).toFixed(2);
					capacityUnits[2] = "TB";
				} else if(rawStorageInfoHddDiskCapacityAvailableValue < 0.01) {
					var hddCapacityAvailable = (rawStorageInfoHddDiskCapacityAvailableValue*conversionFactor).toFixed(2);
					capacityUnits[2] = "MB";
				} else {
					var hddCapacityAvailable = (rawStorageInfoHddDiskCapacityAvailableValue).toFixed(2);
					capacityUnits[2] = "GB";
				}
				var hddCapacityUsedPercent = (rawStorageInfoHddDiskUsedValue/rawStorageInfoHddDiskSizeValue*100).toFixed(0);
				var rawStorageInfoHddDiskVideoUsedValue = stationProperties.storageInfoHdd.video_used/conversionFactor;
				if(rawStorageInfoHddDiskVideoUsedValue >= 1024) {
		...
		if(stationProperties.storageInfoSdCard !== undefined) {
			...
			if(stationProperties.storageInfoSdCard.disk_size !== undefined && stationProperties.storageInfoSdCard.disk_size > 0 && stationProperties.storageInfoSdCard.system_size !== undefined && stationProperties.storageInfoSdCard.system_size >= 0 && stationProperties.storageInfoSdCard.disk_used !== undefined && stationProperties.storageInfoSdCard.disk_used >= 0 && stationProperties.storageInfoSdCard.video_size !== undefined && stationProperties.storageInfoSdCard.video_size >= 0 && stationProperties.storageInfoSdCard.video_used !== undefined && stationProperties.storageInfoSdCard.video_used >= 0) {
				var capacityUnits = ["", "", "", ""];
				var rawStorageInfoSdCardSizeValue = stationProperties.storageInfoSdCard.disk_size/conversionFactor;
				if(rawStorageInfoSdCardSizeValue >= 1024) {
					var sdCardCapacity = (rawStorageInfoSdCardSizeValue/1024).toFixed(2);
					capacityUnits[0] = "TB";
				} else {
					var sdCardCapacity = (rawStorageInfoSdCardSizeValue).toFixed(2);
					capacityUnits[0] = "GB";
				}
				var rawStorageInfoSdCardUsedValue = stationProperties.storageInfoSdCard.disk_used/conversionFactor;
				if(rawStorageInfoSdCardUsedValue >= 1024) {
					var sdCardcCapacityUsed = (rawStorageInfoSdCardUsedValue/1024).toFixed(2);
					capacityUnits[1] = "TB";
				} else {
					var sdCardcCapacityUsed = (rawStorageInfoSdCardUsedValue).toFixed(2);
					capacityUnits[1] = "GB";
				}
				var rawStorageInfoSdCardCapacityAvailableValue = rawStorageInfoSdCardSizeValue-rawStorageInfoSdCardUsedValue;
				if(rawStorageInfoSdCardCapacityAvailableValue >= 1024) {
				...
				var sdCardCapacityUsedPercent = (rawStorageInfoSdCardUsedValue/rawStorageInfoSdCardSizeValue*100).toFixed(0);
				var rawStorageInfoSdCardVideoUsedValue = (stationProperties.storageInfoSdCard.video_used/conversionFactor)/conversionFactor;
				if(rawStorageInfoSdCardVideoUsedValue >= 1024) {
...
async function openModulesManagerModal() {
	...
	document.getElementById("modalModulesManagerUpdateMessage").innerHTML = "";
	document.getElementById("tableContentModulesManager").innerHTML = "";
	myModal.show();
	await startModuleManager();
}
		...
		try {
			...
			if(objResp.success == true) {
				...
				if(updatesCounter == 0) {
					...
					document.getElementById("modalModulesManagerBtnUpdate").setAttribute("disabled", true);
				} else {
					document.getElementById("modalModulesManagerUpdateMessage").removeAttribute("hidden");
					if(updatesCounter == 1) {
						document.getElementById("modalModulesManagerUpdateMessage").innerHTML = translateString("strOneModuleUpdateFound");
					} else {
						document.getElementById("modalModulesManagerUpdateMessage").innerHTML = translateString("strMoreModuleUpdateFound", updatesCounter);
					}
...
async function updateOutdatedModules() {
	var objResp, objErr;
	var url = `${location.protocol}//${location.hostname}/addons/eufySecurity/modulesManager.cgi?action=updateOutdatedModules`;
	document.getElementById("modalModulesManagerUpdateMessage").setAttribute("hidden", true);
	document.getElementById("modalModulesManagerUpdateMessage").innerHTML = "";
	document.getElementById("modalModulesManagerWaitErrorMessage").removeAttribute("hidden");
	document.getElementById("modalModulesManagerWaitErrorMessage").innerHTML = createWaitMessage(translateString("strUpdatingModules"));
	document.getElementById("tableContentModulesManager").innerHTML = "";
	await retrieveData("GET", url, 'application/json', undefined, undefined, undefined, undefined, undefined).then((result) => {
		try {
			objResp = JSON.parse(result);
			if(objResp.success == true) {
				//updateResult = Object.keys(objResp.data);
				startModuleManager();
			} else {
				document.getElementById("modalModulesManagerWaitErrorMessage").removeAttribute("hidden");
				document.getElementById("modalModulesManagerWaitErrorMessage").innerHTML = createMessageContainer("alert alert-danger", translateMessages("messageInstallUpdatesModulesErrorHeader"), "", translateMessages("messageErrorPrintErrorMessage", e));
			}
		} catch (e) {
			document.getElementById("modalModulesManagerWaitErrorMessage").removeAttribute("hidden");
			document.getElementById("modalModulesManagerWaitErrorMessage").innerHTML = createMessageContainer("alert alert-danger", translateMessages("messageInstallUpdatesModulesErrorHeader"), "", translateMessages("messageErrorPrintErrorMessage", e));
