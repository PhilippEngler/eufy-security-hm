...
function translateStaticPageContent(page)
{
    switch(page)
    {
        ...
        case "settings":
            ...
            translateInnerHtml("optLogLevelPleaseSelectAddon");
            translateInnerHtml("optLogLevelPleaseSelectMain");
            translateInnerHtml("optLogLevelPleaseSelectHttp");
            translateInnerHtml("optLogLevelPleaseSelectP2p");
            translateInnerHtml("optLogLevelPleaseSelectPush");
            translateInnerHtml("optLogLevelPleaseSelectMqtt");
