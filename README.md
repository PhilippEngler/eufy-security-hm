...
4. In the new popup, select "Installieren".
5. - If you use a orginal CCU: Wait at least 10 minutes to install. During this time, the WebUI is not accessable. When the installiation is done, the CCU will reboot automatically.
