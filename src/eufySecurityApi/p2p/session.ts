        ...
        if (!this.currentMessageState[message.dataType].invalidStream) {
            switch(message.commandId) {
                ...
                case CommandType.CMD_AUDIO_FRAME:
                    ...
                    break;
                default:
                    this.log.info(`Station ${this.rawStation.station_sn} - Not implemented message`, { commandIdName: CommandType[message.commandId], commandId: message.commandId, channel: message.channel, data: message.data.toString("hex") });
                    break;
            }
        } else {
