...
export enum PropertyName {
    ...
    StationGuardModeTime = "guardModeTime",
    StationCurrentMode = "currentMode",
    StationCurrentModeTime = "currentModeTime",
...
export const BaseDeviceProperties: IndexedProperty = {
    ...
    [GenericWifiSsid.name]: GenericWifiSsid,
}
...
export const DevicePictureTimeProperty: PropertyMetadataNumeric = {
...
export const StationGuardModeTimeProperty: PropertyMetadataNumeric = {
...
export const StationCurrentModeTimeProperty: PropertyMetadataNumeric = {
